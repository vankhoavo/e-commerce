...
@media print{ @page{size:A4 portrait;margin:8mm} html,body{width:210mm!important;background:#fff!important} body>*:not(#app){display:none!important} #app>*:not(.invoice-overlay){display:none!important} .invoice-overlay{position:static!important;display:block!important;padding:0!important;background:#fff!important} .invoice-modal{width:100%!important;max-height:none!important;overflow:visible!important;border:0!important;border-radius:0!important;box-shadow:none!important} .invoice-toolbar,.invoice-actions,.no-print,.order-confirm-overlay{display:none!important} .invoice-sheet{display:block!important;padding:0!important;width:100%!important} .invoice-header{padding-bottom:8px!important}.invoice-header h1{font-size:16pt!important;margin:2px 0!important}.invoice-info-grid{padding:8px 0!important;gap:10px!important}.invoice-table th,.invoice-table td{padding:4px!important;font-size:8pt!important}.invoice-total{margin-top:7px!important;gap:3px!important;width:270px!important}.invoice-status,.invoice-payment-note{margin-top:7px!important;padding:5px 7px!important}.invoice-note{margin-top:7px!important}.invoice-table tr{break-inside:avoid!important} }
</style>
