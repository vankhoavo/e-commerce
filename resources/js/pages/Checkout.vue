...
function validateVatInvoice(): boolean {
    ...
    if (!vat.address.trim()) {
        vatError.value = 'Vui lòng nhập địa chỉ xuất hóa đơn.';
        return false;
    }
    if (!vat.email.trim()) {
                    ...
                    <section class="col-lg-7">
                        ...
                        <div class="checkout-card vat-card">
                            ...
                            <div v-if="form.vatInvoice.requested" class="vat-fields">
                                <div class="vat-info-banner"><i class="bi bi-info-circle-fill"/><span>Vui lòng nhập chính xác thông tin doanh nghiệp/đơn vị để lập hóa đơn.</span></div>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12"><label>Địa chỉ xuất hóa đơn <b>*</b></label><textarea v-model="form.vatInvoice.address" rows="2" maxlength="500" placeholder="Địa chỉ đăng ký của doanh nghiệp/đơn vị"/></div>
                                </div>
