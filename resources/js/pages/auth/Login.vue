...
<div v-if="status === 'registration-success'" class="alert alert-success border-0 rounded-3 shadow-sm"><i class="bi bi-check-circle-fill me-2"/>Đăng ký thành công! Hãy đăng nhập để tiếp tục. Sau khi đăng nhập, hãy xác thực Email bằng mã OTP.</div>
