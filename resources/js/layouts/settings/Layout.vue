...
import { Settings, UserRound, ShieldCheck, UsersRound, Palette, ReceiptText } from '@lucide/vue';
import { onMounted, provide, ref } from 'vue';

export type SettingsSection = 'profile' | 'security' | 'teams' | 'appearance' | 'orders';
