...
<template>
<Head title="Đăng nhập"/><div v-if="status" class="alert alert-success py-2 small">{{ status }}</div><TeamInvitationAlert v-if="teamInvitation" :invitation="teamInvitation" action="Đăng nhập"/>
