    ...
    overlay.innerHTML = `
        <div class="birth-date-modal" role="dialog" aria-modal="true" aria-labelledby="birth-date-title">
            ...
            <div class="birth-date-selectors">
                <label class="birth-date-select"><span>Ngày</span><select class="birth-day" aria-label="Ngày"></select><button type="button" class="birth-date-dropdown-button" aria-label="Mở danh sách ngày"></button></label>
                <label class="birth-date-select"><span>Tháng</span><select class="birth-month" aria-label="Tháng"></select><button type="button" class="birth-date-dropdown-button" aria-label="Mở danh sách tháng"></button></label>
                <label class="birth-date-select"><span>Năm</span><select class="birth-year" aria-label="Năm"></select><button type="button" class="birth-date-dropdown-button" aria-label="Mở danh sách năm"></button></label>
            </div>
