...
<style scoped>
.registration-success-toast{display:flex;align-items:center;gap:12px;margin-bottom:16px;padding:12px 14px;border:1px solid #bfe8d1;border-radius:14px;background:linear-gradient(135deg,#f4fff8,#ecfbf2);box-shadow:0 8px 22px rgba(22,163,74,.09);animation:toast-in .35s ease}.success-toast-icon{display:grid;flex:0 0 36px;width:36px;height:36px;place-items:center;border-radius:50%;color:#fff;background:#16a34a;box-shadow:0 5px 14px rgba(22,163,74,.2);font-size:15px}.success-toast-content{display:flex;min-width:0;flex-direction:column;gap:2px}.success-toast-content strong{color:#166534;font-size:12px;font-weight:850}.success-toast-content span{color:#4b6354;font-size:10px;line-height:1.5}.success-toast-enter-active,.success-toast-leave-active{transition:opacity .3s ease,transform .3s ease}.success-toast-enter-from,.success-toast-leave-to{opacity:0;transform:translateY(-8px)}@keyframes toast-in{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:none}}
</style>
