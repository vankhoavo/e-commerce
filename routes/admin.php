...
Route::middleware(['auth','admin'])->prefix('admin')->name('admin.')->group(function (): void {
    ...
    Route::get('/customers', fn (AdminController $c) => $c->users('customer'))->middleware('admin.permission:customers')->name('customers');
    ...
    Route::patch('/returns/{returnRequest}/reject', [ReturnRequestController::class, 'reject'])->middleware('admin.permission:orders')->name('returns.reject');
    Route::patch('/returns/{returnRequest}/return-to-customer', [ReturnRequestController::class, 'returnToCustomer'])->middleware('admin.permission:orders')->name('returns.return-to-customer');
    ...
    Route::get('/account-deletion-requests', [AccountDeletionController::class, 'adminIndex'])->middleware('admin.permission:customers')->name('account-deletion-requests');
    Route::patch('/account-deletion-requests/{deletionRequest}/approve', [AccountDeletionController::class, 'approve'])->middleware('admin.permission:customers')->name('account-deletion-requests.approve');
    Route::patch('/account-deletion-requests/{deletionRequest}/reject', [AccountDeletionController::class, 'reject'])->middleware('admin.permission:customers')->name('account-deletion-requests.reject');
});
