...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function (): void {
    ...
    Route::get('/customers', fn () => app(AdminController::class)->users(request(), 'customer'))->name('customers');
    Route::post('/customers', fn () => app(AdminController::class)->userStore(request(), 'customer'))->name('customers.store');
    Route::get('/employees', fn () => app(AdminController::class)->users(request(), 'staff'))->name('employees');
    Route::post('/employees', fn () => app(AdminController::class)->userStore(request(), 'staff'))->name('employees.store');
