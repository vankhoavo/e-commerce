...
<template>
    <div v-if="canManageTwoFactor" class="two-factor-manager">
        <div v-if="!twoFactorEnabled" class="two-factor-state">
            ...
            <Link href="/settings/security/forgot-password" class="two-factor-recovery-link"><span class="two-factor-recovery-icon"><i class="bi bi-envelope" /></span><span class="two-factor-recovery-copy"><strong>Quên mật khẩu?</strong><small>Khôi phục tài khoản bằng Email OTP.</small></span><i class="bi bi-arrow-right two-factor-recovery-arrow" /></Link>
        </div>
