    ...
    <nav class="shop-navbar navbar navbar-expand-lg sticky-top"><div class="container nav-container">
        ...
        <div :class="['navbar-collapse', 'client-navbar-collapse', mobileMenuOpen ? 'show' : '']">
            ...
            <div class="nav-actions">
                ...
                <Link v-else href="/settings/profile" class="account-chip"><span class="account-avatar"><img v-if="authUser.avatar" :src="authUser.avatar" alt=""/><i v-else class="bi bi-person-fill"/></span><span class="account-info"><strong>{{ authUser.name }}</strong><small>Tài khoản</small></span><i class="bi bi-chevron-down account-chevron"/></Link>
            </div>
