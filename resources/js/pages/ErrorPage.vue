...
const errorCopy: Record<number, { title: string; description: string; icon: string; label: string }> = {
    ...
    500: {
        ...
        description: 'Máy chủ không thể hoàn tất yêu cầu vừa rồi. Chúng tôi đã ghi nhận lỗi.',
        icon: 'bi-cpu-fill',
        label: '500 · Lỗi máy chủ',
    },
    503: {
        title: 'Dịch vụ đang tạm thời bận',
...
const detail = props.message && props.status >= 400 && props.status < 600 ? props.message : null;
</script>
                ...
                <section class="error-content">
                    <div class="error-visual">
                        <div class="error-icon-ring">
                            <div class="error-icon-core"><i :class="['bi', copy.icon]"></i></div>
                        </div>
                        <div class="error-mini-code" aria-hidden="true">
                    ...
                    <div class="error-copy">
                        ...
                        <div class="error-actions">
                            ...
                            <button type="button" class="btn error-secondary" @click="window.history.length > 1 ? window.history.back() : window.location.assign('/')">
...
.error-copy{max-width:560px}.error-kicker{display:inline-flex;align-items:center;padding:7px 10px;border-radius:999px;color:#2563eb;background:#edf4ff;font-size:9px;font-weight:900;letter-spacing:.08em}.error-number{margin-top:11px;color:#dbe4f2;font-size:clamp(4.6rem,9vw,7.2rem);font-weight:950;letter-spacing:-.08em;line-height:.84}.error-copy h1{margin:10px 0 10px;color:#101828;font-size:clamp(1.9rem,4vw,3rem);line-height:1.05;font-weight:900;letter-spacing:-.05em}.error-copy p{max-width:520px;color:#667085;font-size:.95rem;line-height:1.75}.error-detail{display:flex;align-items:flex-start;gap:9px;margin-top:16px;padding:11px 13px;border:1px solid #e2e8f0;border-radius:12px;color:#667085;background:#f8fafc;font-size:.75rem;line-height:1.5}.error-detail i{margin-top:2px;color:#2563eb}.error-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:23px}.error-primary,.error-secondary{min-height:44px;padding:0 16px;border-radius:11px;font-size:.75rem;font-weight:850}.error-primary{display:inline-flex;align-items:center;gap:8px;color:#fff;background:linear-gradient(135deg,#2563eb,#4f46e5);box-shadow:0 10px 22px rgba(37,99,235,.18)}.error-primary:hover{color:#fff;transform:translateY(-1px);box-shadow:0 14px 28px rgba(37,99,235,.24)}.error-secondary{display:inline-flex;align-items:center;gap:8px;border:1px solid #dfe5ee;color:#344054;background:#fff}.error-secondary:hover{border-color:#bfd1f5;color:#2563eb;background:#f8fbff}.error-footer{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:15px 28px;border-top:1px solid #edf1f6;color:#98a2b3;font-size:10px}.error-footer span{display:inline-flex;align-items:center;gap:6px}.error-footer i{color:#16a34a}
