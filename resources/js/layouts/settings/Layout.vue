...
function selectSection(section: SettingsSection) {
    ...
    if (typeof window !== 'undefined') {
        ...
        window.history.replaceState({ ...window.history.state, techstoreSettingsSection: section }, '', url);
    }
}
