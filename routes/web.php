...
Route::get('/', [ProductController::class, 'home'])->middleware(RedirectAdminsToBackoffice::class)->name('home');
...
Route::middleware('auth')->group(function (): void {
    ...
    Route::get('/orders/{order}/sales-invoice', [SalesInvoiceController::class, 'download'])->name('orders.sales-invoice');
    Route::patch('/orders/{order}/cancel', [OrderController::class, 'cancel'])->name('orders.cancel');
    Route::patch('/orders/{order}/return', [OrderController::class, 'returnOrder'])->name('orders.return');
});

Route::get('/dashboard', fn () => redirect()->route('profile.edit'))->middleware(['auth','verified'])->name('dashboard');
