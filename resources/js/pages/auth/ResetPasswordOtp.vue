...
defineOptions({
    layout: {
        ...
        description: 'Tạo mật khẩu mới cho tài khoản TechStore.',
    },
});
</script>
...
<template>
    ...
    <div class="forgot-card">
        <div class="forgot-hero">
            <div class="forgot-hero-icon"><i class="bi bi-lock-fill" /></div>
            <div>
                <span>TECHSTORE · BẢO MẬT</span>
                <h2>Đặt lại mật khẩu</h2>
                <p>Tạo mật khẩu mới sau khi xác minh OTP thành công.</p>
            </div>
        </div>

        <Form action="/settings/security/forgot-password/reset" method="post" v-slot="{ errors, processing }" class="forgot-form">
            <div>
                <label for="password">Mật khẩu mới</label>
                <div class="forgot-input">
                    <i class="bi bi-lock" />
                    <PasswordInput id="password" name="password" autocomplete="new-password" required autofocus placeholder="Nhập mật khẩu mới" />
                </div>
            ...
            <div>
                ...
                <div class="forgot-input">
                    ...
                    <PasswordInput id="password_confirmation" name="password_confirmation" autocomplete="new-password" required placeholder="Nhập lại mật khẩu mới" />
                </div>
        ...
        <div class="forgot-note">
            ...
            <span>Mật khẩu mới được kiểm tra theo chính sách mật khẩu chung của TechStore.</span>
        </div>
...
.forgot-input{display:flex;align-items:center;min-height:45px;padding:0 12px;border:1px solid #dfe4ec;border-radius:10px;background:#fff;transition:.18s}
...
.forgot-input :deep(input){width:100%;border:0;outline:0;color:#344054;background:transparent;font-size:11px}
