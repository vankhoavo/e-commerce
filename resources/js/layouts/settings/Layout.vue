...
onMounted(() => selectSection('profile'));
</script>
...
/* The four settings views stay on the same Inertia page. */
body[data-techstore-settings-section="profile"] .settings-tab-panel{display:none}body[data-techstore-settings-section="security"] .settings-profile-block{display:none}body[data-techstore-settings-section="security"] .settings-tab-panel:nth-child(3),body[data-techstore-settings-section="security"] .settings-tab-panel:nth-child(4){display:none}body[data-techstore-settings-section="teams"] .settings-profile-block{display:none}body[data-techstore-settings-section="teams"] .settings-tab-panel:nth-child(2),body[data-techstore-settings-section="teams"] .settings-tab-panel:nth-child(4){display:none}body[data-techstore-settings-section="appearance"] .settings-profile-block{display:none}body[data-techstore-settings-section="appearance"] .settings-tab-panel:nth-child(2),body[data-techstore-settings-section="appearance"] .settings-tab-panel:nth-child(3){display:none}
